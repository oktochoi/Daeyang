...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (message && message.length > 500) {
      alert(t('i18n.language') === 'ko' ? '메시지는 500자를 초과할 수 없습니다.' : 'Message cannot exceed 500 characters.');
          ...
          <form id="contact-form" onSubmit={handleSubmit} data-readdy-form className="space-y-8">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                {t('i18n.language') === 'ko' ? '최대 500자' : 'Maximum 500 characters'}
              </p>
            </div>
            ...
            >
              {isSubmitting ? (t('i18n.language') === 'ko' ? '제출 중...' : 'Submitting...') : t('contact.form.submit')}
            </button>
